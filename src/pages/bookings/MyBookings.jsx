...
const MyBookings = () => {
  ...
  const { data, loading, error } = useFetch(`https://hotel-booking-app-backend-r84q.onrender.com/api/rooms/user/dates/${userid}`)
  ...
  const myData = useFetch(`https://hotel-booking-app-backend-r84q.onrender.com/api/rooms/user/hotel/${userid}`)

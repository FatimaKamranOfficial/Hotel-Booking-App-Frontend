...
const Featured = () => {
    ...
    const { data, loading, error } = useFetch("https://hotel-booking-app-backend-r84q.onrender.com/api/hotels/countByCity?cities=tokyo,istanbul,abha,sydney,london,male")
